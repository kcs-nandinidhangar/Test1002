...
/**
 * The Class GetSalesOrder.
 */
public class GetSalesOrder {
	/** The test case category. */
	private static TestCaseCategory SalesOrderSearch = TestCaseCategory.SALES_ORDER_SEARCH;
	...
	void testGetGlobalSalesOrderHeaderAPI(String testCaseNumber, String description, String exceptedResult,
		...
		LocalStorageContext.addTestInformation(testCaseNumber, SalesOrderSearch.toString());
		...
		TestUtility.updateActualAndExpectedResult(testCaseNumber, SalesOrderSearch.toString(), caraResponseBody,
				cdpResponseBody);
	...
	private static Stream<Arguments> testGetGlobalSalesOrderHeaderAPICategory() {
		List<TestCase> testCases = LocalStorageContext.getTestCasesForCategory(SalesOrderSearch.toString());
