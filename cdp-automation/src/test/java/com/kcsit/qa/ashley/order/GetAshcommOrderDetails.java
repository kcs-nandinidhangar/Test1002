...
public class GetAshcommOrderDetails {
	/** The test case category. */
	private static TestCaseCategory searchOrderByPhoneNoAndOrderNoAshcomm = TestCaseCategory.SEARCH_ORDER_BY_PHONE_AND_ORDER_NO_ASHCOMM;
	...
	void testGetOrderDetailByPhoneNumberAndOrderNumber(String testCaseNumber, String description, String exceptedResult,
		...
		LocalStorageContext.addTestInformation(testCaseNumber, searchOrderByPhoneNoAndOrderNoAshcomm.toString());
		...
		ResponseBody<?> caraResponseBody = given()
				...
				.get("https://test.cara.ashleyretail.com/odata/AshCommSalesOrder?" + inputData).getBody();
		...
		ResponseBody<?> cdpResponseBody = given()
				...
				.get("http://cdp.stage.ashleyretail.com/ashcomm-salesorder/odata/AshCommSalesOrder?" + inputData).getBody();
		/* CDP API Request End */
		/* Test Case Modification end from here */
		
		TestUtility.updateActualAndExpectedResult(testCaseNumber, searchOrderByPhoneNoAndOrderNoAshcomm.toString(),
	...
	private static Stream<Arguments> testGetOrderDetailByPhoneNumberAndOrderNumberCategory() {
		List<TestCase> testCases = LocalStorageContext
				.getTestCasesForCategory(searchOrderByPhoneNoAndOrderNoAshcomm.toString());
